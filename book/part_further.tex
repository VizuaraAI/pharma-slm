...
\fig{figures/diag_rag.png}{0.98}{The retrieval-augmented generation flow. The question is embedded and matched
against a 300{,}000-passage PubMed index; the top matches are pasted into the prompt; the 1.3B model answers
grounded in them and returns the citations.}
